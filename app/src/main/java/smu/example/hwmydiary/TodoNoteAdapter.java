...
public class TodoNoteAdapter extends RecyclerView.Adapter<TodoNoteAdapter.ViewHolder> {
    private static final String TAG = "TodoNoteAdapter";
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        TodoNote item = items.get(position);
        holder.setItem(item);
        holder.setLayout();
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                private void deleteToDo(String TODO){
                    ...
                    String deleteSql = "delete from " + TodoNoteDatabase.TABLE_NOTE + " where " + "  TODO = '" + TODO+"'";
        ...
        public void setItem(TodoNote item){
    ...
    // 배열에 있는 item들을 가리킴
    public void setItems(ArrayList<TodoNote> items){
        this.items = items;
    }
}