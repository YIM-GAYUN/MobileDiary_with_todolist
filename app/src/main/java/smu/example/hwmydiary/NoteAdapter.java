    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setItem(Note item) {
            ...
            if (picturePath != null && !picturePath.equals("")) {
                ...
                pictureImageView.setImageResource(R.drawable.choicesong);
        ...
        public void setMoodImage(int moodIndex) {
            switch(moodIndex) {
                case 0:
                    moodImageView.setImageResource(R.drawable.song1);
                    moodImageView2.setImageResource(R.drawable.song1);
                    break;
                case 1:
                    moodImageView.setImageResource(R.drawable.song2);
                    moodImageView2.setImageResource(R.drawable.song2);
                case 2:
                    moodImageView.setImageResource(R.drawable.song3);
                    moodImageView2.setImageResource(R.drawable.song3);
                    break;
                case 3:
                    moodImageView.setImageResource(R.drawable.song4);
                    moodImageView2.setImageResource(R.drawable.song4);
                    break;
                case 4:
                    moodImageView.setImageResource(R.drawable.song5);
                    moodImageView2.setImageResource(R.drawable.song5);
                    break;
                default:
                    moodImageView.setImageResource(R.drawable.song3);
                    moodImageView2.setImageResource(R.drawable.song3);
